...
<aside id="comments">
	...
	<aside class="project_navi">
		...
		<div class="divider" style="padding-bottom:20px; margin-top:40px;"></div>
	</aside>
	<?php } ?>
...
?>
    ...
    <?php 
	   ...
	   <?php endif; ?>
		...
		<div class="cl"></div>
		<br />
		<a class="button" id="submittedContact" href="javascript: submitform();"><span><?php _e('Add Comment', 'cmsmasters'); ?></span></a>
		<div class="cl"></div>
		<br />
	</aside>
<?php 
