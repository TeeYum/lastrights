...
function wp_pagenavi($query = '', $before = '', $after = '') {
		...
		if ($max_page > 1 || intval($pagenavi_options['always_show']) == 1) {
            ...
            case 1:
                ...
                if ($start_page >= 2 && $pages_to_show < $max_page) {
                    ...
                    echo '<a href="' . esc_url(get_pagenum_link()) . '" class="first" title="' . $first_page_text . '"><span>' . $first_page_text . '</span></a>';
                ...
                if ($larger_page_to_show > 0 && $larger_start_page_start > 0 && $larger_start_page_end <= $max_page) {
                    for ($i = $larger_start_page_start; $i < $larger_start_page_end; $i += $larger_page_multiple) {
                        ...
                        echo '<a href="' . esc_url(get_pagenum_link($i)) . '" class="page" title="' . $page_text . '"><span>' . $page_text . '</span></a>';
                    }
                }
                
                if ($start_page != $paged && $end_page <= 5) {
                    previous_posts_link('<span>&lt;</span>'); 
                }
                ...
                if ($end_page < $max_page) {
                    ...
                    echo '<a href="' . esc_url(get_pagenum_link($max_page)) . '" class="last" title="' . $last_page_text . '"><span>' . $last_page_text . '</span></a>';
                }
...
function pagenavi_init() {
	...
	$pagenavi_options['pages_text'] = __('Page', 'cmsmasters') . ' %CURRENT_PAGE% ' . __('of', 'cmsmasters') . ' %TOTAL_PAGES%';
	...
	add_option('pagenavi_options', $pagenavi_options, '', 'yes');
}
