...
(function () {
	tinymce.create('tinymce.plugins.<?php echo $cmsmasters_shortcode_dropcap->buttonName; ?>', {
		...
		createControl : function (n, c) {
			if (n === '<?php echo $cmsmasters_shortcode_dropcap->buttonName; ?>') {
                var b = c.createSplitButton('<?php echo $cmsmasters_shortcode_dropcap->buttonName; ?>List', {
