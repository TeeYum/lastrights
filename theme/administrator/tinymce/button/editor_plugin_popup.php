            ...
            <table class="describe">
                <tbody>
                    ...
                    <tr>
                        <th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
                            <span class="alignleft">
                                <label for="button_bg"><?php _e('Background Color', 'cmsmasters'); ?></label>
                            </span>
                        </th>
                        <td class="field" style="padding-top:10px;">
                            <input type="color" value="" name="button_bg" id="button_bg" style="width:80px" data-hex="true" class="popup_tr_value" />
                        </td>
                    </tr>
                    <tr>
                        <th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
                        ...
                        <td class="field" style="padding-top:10px;">
                            <input type="color" value="" name="button_color" id="button_color" style="width:80px" data-hex="true" class="popup_tr_value" />
                        </td>
                    </tr>
                    <tr>
                        <th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
