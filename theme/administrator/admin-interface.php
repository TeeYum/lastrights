...
?>
    ...
    <script type="text/javascript">
        jQuery(function () {
            ...
            jQuery('.slider .rght .tabb').css( { minHeight : '650px' } );
    ...
    <div class="slider wrap">
        <div class="bot">
            ...
            <ul class="tabs">
                ...
                <li>
					<a href="#background_options" title="<?php _e('Styling Options', 'cmsmasters'); ?>">
                    ...
                    <ul>
                        <li>
							<a href="#background_options" title="<?php _e('Background & Header', 'cmsmasters'); ?>"><?php _e('Background & Header', 'cmsmasters'); ?></a>
						</li>
                        <li>
							<a href="#logo_options" title="<?php _e('Logo & Favicon', 'cmsmasters'); ?>"><?php _e('Logo & Favicon', 'cmsmasters'); ?></a>
						</li>
                        <li>
            ...
            <div class="rght">
                ...
                <form method="post" action="<?php echo home_url(); ?>/wp-admin/admin.php?page=<?php echo $shortname; ?>-options&amp;saved=true" id="adminoptions_form">
                <?php
                    ...
                    ?>
                        ...
                        <tr>
                            <td valign="top">
                                ...
                                <input size="10" name="<?php echo $value['id']; ?>" id="<?php echo $value['id']; ?>" type="text" value="<?php 
                                if ($get_options[$id] != '') {
                                    echo stripslashes(htmlspecialchars($get_options[$id]));
                                } else {
                                    echo $value['std'];
                                ...
                                <div class="mycolorpicker_parent">
                                    <div class="mycolorpicker" id="<?php echo $value['id']; ?>_mycolor"></div>
                                    <div id="<?php echo $value['id']; ?>_colorpicker"<?php 
                                    if ($get_options[$id] != '') { 
                                        ?> style="background-color:#<?php echo stripslashes(htmlspecialchars($get_options[$id])); ?>;"<?php 
                                    } else { 
                                        ?> style="background-color:#<?php echo $value['std']; ?>;"<?php 
                                    } ?>></div>
                                </div>
                                <script type="text/javascript">
                                    jQuery(document).ready(function () {
                                        jQuery('#<?php echo $value['id']; ?>, #<?php echo $value['id']; ?>_mycolor').ColorPicker( {
                                            onSubmit : function(hsb, hex, rgb, el) {
                                                jQuery('#<?php echo $value['id']; ?>').val(hex);
                                                jQuery('#<?php echo $value['id']; ?>_colorpicker').css('backgroundColor', '#' + hex)
                                            ...
                                            onBeforeShow : function () {
                                                jQuery(this).ColorPickerSetColor(jQuery('#<?php echo $value['id']; ?>').val());
                                            }
                                        } );
                                    } );
                                </script>
                    ...
                    ?>
                        ...
                        <tr>
                            <td valign="top" style="padding-bottom:0;">
                                <div class="select_bgs" id="<?php echo $value['id']; ?>_patterns_bgs">
                                    <span class="fl" style="display:block; width:140px; padding:5px 0 0;"><?php _e('Patterns', 'cmsmasters'); ?></span>
                                    <?php
                                    foreach ($value['options'] as $option) {
                                ...
                                <div class="select_bgs" id="<?php echo $value['id']; ?>_transparents_bgs">
                                    <span class="fl" style="display:block; width:140px; padding:5px 0 0;"><?php _e('Transparent Images', 'cmsmasters'); ?></span>
                                    <?php
                                    foreach ($value['options'] as $option) {
                                        if ($option->bg_type == 'bg_t_i') {
                                            ...
                                            if ($option->bg_url != '' && $option->bg_url != 'none') {
                                                echo "<a$selected href='" . get_template_directory_uri() . "/images/bgs/" . $option->bg_url . "' style='background-image:url(" . get_template_directory_uri() . "/images/bgs/" . $option->bg_thumb_url . ");'>&nbsp;</a>";
                                            } elseif ($option->bg_url == 'none') {
                                                echo "<a$selected href='#' style='background-image:url(" . get_template_directory_uri() . "/images/bgs/" . $option->bg_thumb_url . ");'>&nbsp;</a>";
                                            }
                                        }
                                    }
                                    ?>
                                        ...
                                        jQuery(document).ready(function () {
                                            ...
                                            new AjaxUpload(btnUpload, {
                                                ...
                                                onComplete : function (file, response) {
                                                    ...
                                                    if ( response !== 'error') {
                                                        jQuery('#<?php echo $value['id']; ?>').val('<?php echo get_template_directory_uri(); ?>/images/cache/' + response);
                                                        
                                                        if (jQuery('#<?php echo $value['id']; ?>_image').find('img').length > 0) {
                                                            jQuery('#<?php echo $value['id']; ?>_image img').attr( { src : '<?php echo get_template_directory_uri(); ?>/images/cache/' + response } );
                                                        } else {
                                                            jQuery('#<?php echo $value['id']; ?>_image').prepend('<img src="<?php echo get_template_directory_uri(); ?>/images/cache/' + response + '" alt="" />');
                                                        }
                            ...
                            <tr>
                                <td valign="top">
                                    ...
                                    <div id="<?php echo $value['id']; ?>_image"<?php if ($get_options[$id] != '') { 
                                        ...
                                        if ($get_options[$id] != '') { 
                                            ?> margin:10px 0;<?php 
                                        } ?> background:url(<?php echo get_template_directory_uri(); ?>/theme/classes/timthumb.php?src=<?php echo stripslashes(htmlspecialchars($get_options[$id])); ?>&w=400&h=250&zc=1) top center no-repeat;"<?php 
                                    } ?>></div>
                                    <div<?php if ($get_options[$id] == '') { 
                                        ?> style="display:none;"<?php 
                                    } ?>>
                                            ...
                                            new AjaxUpload(btnUpload, {
                                                ...
                                                onComplete : function (file, response) {
                                                    ...
                                                    if (response !== 'error') {
                                                        ...
                                                        jQuery('#<?php echo $value['id']; ?>_image').css( { background : 'url(<?php echo get_template_directory_uri(); ?>/theme/classes/timthumb.php?src=<?php echo get_template_directory_uri(); ?>/images/bgs/' + response + '&w=400&h=250&zc=1) top center no-repeat', width : '400px', height : '250px', margin : '10px 0' } );
                    ...
                    ?>
                        ...
                        <tr>
                            <td valign="top" style="padding-bottom:0;" class="theme_bg_add_block">
                                <div class="bgs" id="<?php echo $value['id']; ?>_patterns_bgs">
                                    <span class="fl" style="display:block; width:140px; padding:5px 0 0;"><?php _e('Patterns', 'cmsmasters'); ?></span>
                                    <?php
                                    foreach ($value['options'] as $option) {
                                        if ($option->bg_type == 'bg_t') {
                                ...
                                <div class="bgs" id="<?php echo $value['id']; ?>_transparents_bgs">
                                    <span class="fl" style="display:block; width:140px; padding:5px 0 0;"><?php _e('Transparent Images', 'cmsmasters'); ?></span>
                                    <?php
                                    foreach ($value['options'] as $option) {
                                        if ($option->bg_type == 'bg_t_i') {
                                        ...
                                        new AjaxUpload(btnUpload, {
                                            ...
                                            onComplete : function(file, response) {
                                                ...
                                                if (response !== 'error') {
                                                    ...
                                                    jQuery('#<?php echo $value['id']; ?>_image').css( { background : 'url(<?php echo get_template_directory_uri(); ?>/theme/classes/timthumb.php?src=<?php echo get_template_directory_uri(); ?>/images/bgs/' + response.split(',')[0] + '&w=400&h=250&zc=1) top center no-repeat', width : '400px', height : '250px', margin : '10px 0' } );
                                                    jQuery('#<?php echo $value['id']; ?>_image').fadeIn();
                                                    jQuery('#<?php echo $value['id']; ?>_clear').parent().fadeIn();
                                                } else {
                                                    alert('<?php _e('File', 'cmsmasters'); ?> ' + file + ' <?php _e('do not load...', 'cmsmasters'); ?>')
                                    ...
                                    jQuery(document).ready(function () {
                                        ...
                                        jQuery('.theme_bg_add_block a').live('click', function () {
                                            ...
                                            if (params[6] === 'bg_t'){
                                                ...
                                                jQuery('#<?php echo $value['id']; ?>_image').css( { background : '#333333 url(<?php echo get_template_directory_uri(); ?>/theme/classes/timthumb.php?src=<?php echo get_template_directory_uri(); ?>/images/bgs/' + params[0] + '&w=400&h=250&zc=1) ' + params[2] + ' ' + params[3] + ' ' + params[4], width : '400px', height : '250px', border : '0', margin : '10px 0' } );
                                            } else if (params[6] === 'bg_i'){
                                                jQuery('#<?php echo $value['id']; ?>_image').css( { background : 'url(<?php echo get_template_directory_uri(); ?>/theme/classes/timthumb.php?src=<?php echo get_template_directory_uri(); ?>/images/bgs/' + params[0] + '&w=400&h=250&zc=1) ' + params[2] + ' ' + params[3] + ' ' + params[4], width : '400px', height : '250px', border : '0', margin : '10px 0' } );
                                            }
...
function update_notifier_menu_cmsms() {
    global $themename, $shortname, $options, $page_handle;
    ...
    if (function_exists('simplexml_load_string')) {
        ...
        if ((float) $xml->latest > (float) $theme_data['Version']) {
            remove_menu_page($page_handle);
            add_menu_page($themename . ' ' . __('Options', 'cmsmasters'), $themename . ' <span class="update-plugins count-1"><span class="update-count">' . $xml->latest . '</span></span>', 'edit_themes', $page_handle, 'cmsmasters_admin_options');
        }
    }
}
...
add_action('admin_menu', 'update_notifier_menu_cmsms');
